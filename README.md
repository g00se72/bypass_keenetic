...
`Установка и удаление` -> `Установка & переустановка` :

После установки возникнет ошибка `Starting dnsmasq... failed` до включения `DNS Override`

Добавить через бота в списки обхода неодбодимые вам домены
